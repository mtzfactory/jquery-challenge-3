...
Probando el metodo de Spotify de autenticación [Client credentials flow][credentials-flow] directamente en la webapp, resulta en un problema de **CORS**, por esta razón cree un servicio que devuelve un token actualizado.
